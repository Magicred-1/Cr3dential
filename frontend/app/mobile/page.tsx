...
export default function Home() {
  return (
    <div className={`overflow-hidden w-full h-screen ${lexend.className}`}>
      ...
      <div className="z-10 w-full absolute top-0 px-[1%] py-[2%] bg-transparent flex flex-row justify-between">

        <Image width="90" height="90" src="/logo_cr3dential_white.svg" alt=""></Image>

        <a className='relative px-[1%] py-[0.4%] cursor-pointer text-center font-light
          transition-all ease-in-out duration-200
          box-border sm:border-[2px] border-[1px] border-solid border-white rounded-[7px]
      ...
      <div className="absolute w-full top-[40%] flex flex-col text-center px-[5%]">
        ...
        <div>
          <a className='relative px-[3%] py-[2%] cursor-pointer text-center font-light
              transition-all ease-in-out duration-200
