    ...
    <div className={`overflow-hidden w-full h-screen background-ui ${lexend.className}`}>
      ...
      <div className='-mt-12 flex flex-col w-full h-full justify-center items-center'>
        ...
        grid grid-cols-2 justify-center items-center gap-1 p-2'>
          ...
          <div className='flex flex-col gap-3 items-center'>
            <Image className='cursor-pointer hover:scale-110 transition-all ease-in-out duration-300'
            alt=""  width="80" height="80" src="/pp-orga2.png"></Image>
            École 42
          </div>
          ...
          <div className='flex flex-col gap-3 items-center'>
            <Image className='cursor-pointer hover:scale-110 transition-all ease-in-out duration-300'
            alt=""  width="80" height="80" src="/pp-orga3.png"></Image>
            ETS Global
          </div>
          ...
          <div className='flex flex-col gap-3 items-center'>
            <Image className='cursor-pointer hover:scale-110 transition-all ease-in-out duration-300'
            alt=""  width="80" height="80" src="/pp-orga4.png"></Image>
            Moodle
          </div>
          ...
          <div className='flex flex-col gap-3 items-center'>
            <Image className='cursor-pointer hover:scale-110 transition-all ease-in-out duration-300'
            alt=""  width="80" height="80" src="/pp-orga5.png"></Image>
            TSP
          </div>
          ...
          <div className='flex flex-col gap-3 items-center'>
            <Image className='cursor-pointer hover:scale-110 transition-all ease-in-out duration-300'
            alt=""  width="80" height="80" src="/pp-orga6.png"></Image>
            Google
          </div>
